...
// Create new thread
router.post('/threads', isAuthenticatedUser, upload.array('images', 10), createThread);
...
router.post('/threads/:threadId/posts', isAuthenticatedUser, upload.array('images', 10), createPost);
...
router.delete('/threads/:threadId/interaction', isAuthenticatedUser, removeThreadInteraction);
