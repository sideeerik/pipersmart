      ...
      <div className="admin-sidebar-inner">
        ...
        <div className="admin-sidebar-brand" onClick={() => navigate('/admin/dashboard')}>
          ...
          <div className="admin-sidebar-brand-text">
            <div className="admin-sidebar-brand-title">PiperSmart</div>
            <div className="admin-sidebar-brand-subtitle">Admin</div>
          </div>
        </div>
        ...
        <div className="admin-sidebar-user">
          ...
          >
            {user?.avatar?.url ? (
              <img src={user.avatar.url} alt="Admin Avatar" className="admin-sidebar-user-avatar" />
            ) : (
            ...
            <div className="admin-sidebar-user-info">
              ...
              <div className="admin-sidebar-user-email">{user?.email ? user.email.substring(0, 18) + '...' : 'Admin'}</div>
            </div>
          </button>

          {dropdownOpen && (
            <div className="admin-sidebar-user-menu">
              <div className="admin-sidebar-user-menu-head">
                <div className="admin-sidebar-user-menu-name">{user?.name || 'Administrator'}</div>
                <div className="admin-sidebar-user-menu-email">{user?.email || 'No email'}</div>
                <div className="admin-sidebar-user-menu-role">Role: Administrator</div>
              </div>
              <button
                type="button"
                className="admin-sidebar-user-menu-btn"
              ...
              <button
                type="button"
                className="admin-sidebar-user-menu-btn danger"
